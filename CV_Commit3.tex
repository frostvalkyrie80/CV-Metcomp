...
\cvevent{Astronauta}{NASA}{Janeiro 2082 -- 2085}{Terra}{Consegui um sinal de rádio que me disse o ano atual. Usando ele descobri que ano em que me perdi.
\begin{itemize}
...
\cvevent{Catador de pedras Marcianas}{NASA?}{2085 -- 2089}{Marte}
\begin{itemize}
...
\cvevent{Objetivo 1}{}{}{}
\begin{itemize}
\item Abraçar minha família novamente
\end{itemize}
...
\cvevent{Objetivo 2}{}{}{}
\begin{itemize}
\item Me despedir dos amigos marcianos
\end{itemize}
\medskip
...
\wheelchart{1.5cm}{0.5cm}{%
  6/8em/accent!30/{Confraternizar com \\criaturas esquisitas},
  3/8em/accent!40/Manutenção do \\sinal de rádio,
  8/8em/accent!60/Procurar Alimentos,
  2/10em/accent/Ansiedade para a volta,
  5/6em/accent!20/Chorar de emoção
}
